...
<?php
session_start();
//laczenie z plikiem przechowującym polączenie z baza danych
include '../cfg.php';
...
//wyświetlanie listy podstron razem z opcjami edycji i usuwania
...
//metoda pozwalająca na usuniecie nacej podstrony-uzycie w ListaPodstron()
...
if(isset($_SESSION['status_logowania']) && $_SESSION['status_logowania'] == 1){
	echo '<h1>Jesteś zalogowany i masz dostęp do metod administracyjnych.</h1>';
	ListaPodstron();
